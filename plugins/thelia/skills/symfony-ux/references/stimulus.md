...
**HTML drives, JS responds.** Controllers don't create markup. They attach behavior to existing HTML. When a controller starts generating DOM, the use case belongs to a TwigComponent (static) or LiveComponent (reactive).
...
Official documentation: https://stimulus.hotwired.dev/ and https://symfony.com/bundles/StimulusBundle/current/index.html
